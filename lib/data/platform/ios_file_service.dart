...
/// iOS implementation of [PlatformFileService] using UIDocumentPicker and NSFileCoordinator.
///
/// This implementation works within iOS sandbox constraints and uses
/// UIDocumentPicker for accessing files outside the app sandbox.
class IOSFileService implements PlatformFileService {
  /// Creates a new [IOSFileService] instance.
  ...
  Future<List<String>> getRootDirectories() async {
    try {
      ...
      // Note: Access to files outside the app sandbox requires UIDocumentPicker
      // which requires user interaction. Those paths are managed separately.
      return roots;
    } catch (e) {
  ...
  Future<void> openFile(String path) async {
    // On iOS, we delegate to the system to open files
    // This would typically use UIDocumentInteractionController
    // For now, we'll throw an exception indicating this needs platform-specific implementation
    throw UnimplementedError(
      'Opening files on iOS requires platform-specific implementation using UIDocumentInteractionController',
    );
  }
